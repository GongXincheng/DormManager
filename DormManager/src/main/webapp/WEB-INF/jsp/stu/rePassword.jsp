	...
	<div class="container">
		<div class="col-md-2">
			<div class="list-group" id="nav">
			  ...
			  <a href="/page/stu/rePassword.html" class="list-group-item active">修改密码</a>
		...
		<div class="col-md-10">
			<div class="panel panel-default table-responsive" style="padding-bottom: 30px;">
			  ...
			  <div style="margin-top: 5%;">
			  	...
			  	<div class="col-md-8">
			  		<form action="${pageContext.request.contextPath}/stu/changePassword.html" method="post" class="form-horizontal">
...
$(function(){
	$("#btnUpdatePassword").click(function(){
		...
		$.post("${pageContext.request.contextPath}/stu/changePassword.action",
